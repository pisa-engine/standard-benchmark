...
sourcesIndex["stdbench"] = {"name":"","dirs":[{"name":"build","files":["mod.rs"]},{"name":"command","files":["mod.rs"]},{"name":"config","dirs":[{"name":"yaml","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"error","files":["mod.rs"]},{"name":"executor","files":["mod.rs"]},{"name":"run","files":["mod.rs"]},{"name":"source","files":["mod.rs"]}],"files":["lib.rs"]};
